...
callback_action_mapping = [
    ...
    (theme.input_theme_field_to_edit, ThemeEditCallbackFactory.filter(F.action == "edit_name")),
    (theme.input_theme_field_to_edit, ThemeEditCallbackFactory.filter(F.action == "edit_description")),
    (theme.input_theme_field_to_edit, ThemeEditCallbackFactory.filter(F.action == "edit_gpt")),
